...
-   Begin to familiarise y ourself with RStudio (and by extension R's tidyverse)
...
**The file has 1846 rows rows and 3 columns. The variables are `dataset`, `x`, and `y`.**
...
**The star data has a slightly less negative correlation than the dino data.**
...
**The circle dataset has a slightly more negative correlation than the other two.**
